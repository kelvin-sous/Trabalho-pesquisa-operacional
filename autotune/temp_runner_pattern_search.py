# Auto-generated runner for Pattern Search
import sys
import os
import json
import numpy as np
...
def main():
    ...
    with open(r"temp_optimization/config_pattern_search.json", "r") as f:
        config = json.load(f)
    ...
    print("="*70)
    print(f"   OTIMIZAÇÃO: PATTERN SEARCH")
    print("="*70)
    print()
    ...
    elif "Pattern Search" == "Particle Swarm":
        optimizer = PatternSearch(
            objective_function=run_external_program,
            x0=config["x0"],
            n_particles=30,
    ...
    try:
        ...
        result_file = r"temp_optimization/config_pattern_search.json".replace("config", "result")
        with open(result_file, "w") as f:
            json.dump(results, f, indent=2)
        
        print("\n" + "="*70)
        print(f"   PATTERN SEARCH - OTIMIZAÇÃO CONCLUÍDA")
        print("="*70)
        log(f"")
